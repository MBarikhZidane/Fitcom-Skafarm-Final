...
<div class="pb-5">
    <div class="container">
        ...
        <?php $UserTransaksi = !empty($transaksiList ?? []);?>
        ...
        <?php if (!empty($transaksiBelumKomen)): ?>
            <div class="row">
                <div class="col-12">
        ...
        <?php elseif (!$UserTransaksi): ?>
            <div class="row">
                <div class="col-12">
                    <h4>Anda harus beli untuk mengomentari produk ini.</h4>
                </div>
            </div>
        <?php else: ?>
            <div class="row">
                <div class="col-12">
                    <h4>Anda Sudah mengomentari semua transaksi.</h4>
                </div>
            </div>
        <?php endif; ?>
